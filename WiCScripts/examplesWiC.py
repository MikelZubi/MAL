...
import time
from generatePrompt import generate_promptExamples, generate_promptV2
import os
...
def testModels(word, example1, example2, POS, tag, pipeline, tokenizer, sb, file, modelname, kE, few):
    ...
    prompt1 = generate_promptExamples(modelname,tokenizer,word,example1, kE, few)
    prompt2 = generate_promptExamples(modelname,tokenizer,word,example2, kE, few)
...
if __name__ == "__main__":
    ...
    filename = "WiCOutputs/" + str(kF) + "Shot"+str(kE)+"Examples/" + modelname + ".json"
