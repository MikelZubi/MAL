...
import time
from generatePrompt import generate_promptV2, generate_promptExamples
import os
...
def testModels(word, example1, example2, POS, tag, pipeline, tokenizer, sb, file, modelname, kE, fewN, fewV):
    ...
    prompt1 = generate_promptExamples(modelname,tokenizer,word,example1, POS, kE, fewN, fewV)
    prompt2 = generate_promptExamples(modelname,tokenizer,word,example2, POS, kE, fewN, fewV)
